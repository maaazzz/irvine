					...
					<div class="all-products d-md-flex position-relative">
						<div class="product-filter">
							<div class="filter-part">
								...
								<div class="filter-option">
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-category" id="filter1Check1" checked />
										<label class="custom-control-label" for="filter1Check1">All Items</label>
									</div>
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-category" id="filter1Check2" />
										<label class="custom-control-label" for="filter1Check2">Cleaning Products</label>
									</div>
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-category" id="filter1Check3" />
										<label class="custom-control-label" for="filter1Check3">Safety Products</label>
									</div>
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-category" id="filter1Check4" />
										<label class="custom-control-label" for="filter1Check4">Batteries</label>
									</div>
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-category" id="filter1Check5" />
										<label class="custom-control-label" for="filter1Check5">Stationary</label>
									</div>
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-category" id="filter1Check6" />
										<label class="custom-control-label" for="filter1Check6">Clothing</label>
									</div>
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-category" id="filter1Check7" />
										<label class="custom-control-label" for="filter1Check7">General Supplies</label>
									</div>
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-category" id="filter1Check8" />
										<label class="custom-control-label" for="filter1Check8">Janitorial</label>
									</div>
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-category" id="filter1Check9" />
										<label class="custom-control-label" for="filter1Check9">Paint</label>
									</div>
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-category" id="filter1Check10" />
							...
							<div class="filter-part">
								...
								<div class="filter-option">
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-location" id="filter2Check1" checked />
										<label class="custom-control-label" for="filter2Check1">All Locations</label>
									</div>
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-location" id="filter2Check2" />
										<label class="custom-control-label" for="filter2Check2">Central Warehouse</label>
									</div>
									<div class="custom-control custom-checkbox">
										<input type="radio" class="custom-control-input" name="select-location" id="filter2Check3" />
